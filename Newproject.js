document.addEventListener('DOMContentLoaded', function () {
    ...
    // Modal handling
    document.querySelector('[data-modal-trigger="join-now"]').addEventListener('click', function (e) {
        e.preventDefault();
        // Show modal with fade-in animation
        document.getElementById('joinNowModal').classList.add('active');
        // Auto-focus first form field
        document.querySelector('#joinNowModal input[name="name"]').focus();
